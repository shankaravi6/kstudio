    ...
    <SoBox w="100%">
      <SoFlex w="100%" h='unset' jc="center" gap='20px' dir='column'>
        <SoFlex dir='column' al='flex-end'>
          <SoSubTitle ta='left' fs="clamp(1.5rem,5vw,4rem)">ABOUT US</SoSubTitle>
          {/* <SoHeadLineText fs="clamp(1.25rem,5vw,3.8rem)">from</SoHeadLineText>
          <SoSubTitle fs="clamp(1.15rem,5vw,3.7rem)">KANCHIPURAM</SoSubTitle> */}
        </SoFlex>
        <SoBox>
            <SoTypography fs="clamp(.25rem, 5vw, 1.5rem)" ls='0px' color={palette.text.low}>
            Lorem ipsum dolor sit amet consectetur adipiscing elit, non vitae nunc congue erat in, pharetra facilisis ridiculus porta augue nam. Lorem ipsum dolor sit amet consectetur adipiscing elit, non vitae nunc congue erat in, pharetra facilisis ridiculus porta augue nam. Lorem ipsum dolor sit amet consectetur adipiscing elit, non vitae nunc congue erat in, pharetra facilisis ridiculus porta augue nam.
            </SoTypography>
        </SoBox>
