...
export const SoFlex = SiloComponent(styled.div`
  ...
  position: ${(props) => (props.pos ? props.pos : "unset")};
...
export const SoGrid = SiloComponent(styled.div`
  display: grid;
  ...
  @media screen and (max-width: 970px) {
    grid-template-columns: ${(props) =>
      props.sm_columns ? props.sm_columns : "repeat(auto-fit, minmax(150px, 1fr))"};
  ...
  @media screen and (max-width: 600px) {
    grid-template-columns: ${(props) =>
      props.xs_columns ? props.xs_columns : "repeat(auto-fit, minmax(100px, 1fr))"};
...
export const SoBox = styled.div`
  ...
  &:hover {
    box-shadow: ${(props) => (props.bsHover ? props.bsHover : "none")};
  }
`;
